...
usbport = '/dev/ttyACM0'
if ARDUINO: ser = serial.Serial(usbport, 9600, timeout = .10)
ID_TIMER = 2000
ID_TIMER2 = 2001
serDelay = 50
countdownDelay = 1000
...
class mainWin(wx.Frame):
    def __init__(self, *args, **kwargs):
        ...
        self.modes = ['Single', 'Double', 'Final', 'Clue', 'Klok', 'Response', 'Daily', 'Blank']
...
#DEBUG        print "XXXX - Current team: ", self.currTeam, -1*points
    ...
    def updateHeader(self):
        ...
        miceTitle = wx.StaticBox(micePanel, label=self.teams[0].name, pos=(5,5), size=(550,210))
        ...
        menTitle = wx.StaticBox(menPanel, label=self.teams[1].name, pos=(5,5), size=(550,210))
