...
bitmapDir = os.path.join(dirName, 'media')
...
class MediaPanel(wx.Panel):
    ...
    def buildAudioBar(self):
        ...
        imageFile = os.path.join(bitmapDir, "pngTest.png")
        img = wx.Image(imageFile, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
        self.playPauseBtn = buttons.GenBitmapToggleButton(self, bitmap=img, name="play")
        self.playPauseBtn.Enable(False)
 
        imageFile = os.path.join(bitmapDir, "player_pause.png")
        img = wx.Image(imageFile, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
    ...
    def buildBtn(self, btnDict, sizer):
        ...
        imageFile = os.path.join(bitmapDir, bmp)
        img = wx.Image(imageFile, wx.BITMAP_TYPE_ANY).ConvertToBitmap()
